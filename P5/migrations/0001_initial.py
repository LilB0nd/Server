    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Table_Nr', models.CharField(choices=[('table_1', 'Tisch 1'), ('table_2', 'Tisch 2'), ('table_3', 'Tisch 3')], default=None, max_length=10)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='P5.order')),
            ],
        ),
        migrations.AddField(
            model_name='order',
            name='Dish_list',
            field=models.ManyToManyField(through='P5.Quantity', to='P5.Dish'),
        ),
        migrations.CreateModel(
            name='DishTyp',
            fields=[
                ...
                ('Dish_Category', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='P5.dishcategory')),
            ],
            options={
