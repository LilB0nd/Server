# Generated by Django 3.0.5 on 2021-05-17 18:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_price_currency', djmoney.models.fields.CurrencyField(choices=[('EUR', 'EURO €')], default='EUR', editable=False, max_length=3)),
                ('total_price', djmoney.models.fields.MoneyField(currency_choices=(('EUR', 'EURO €'),), decimal_places=2, default_currency='EUR', max_digits=9, verbose_name='Gesamtsumme')),
                ('given_currency', djmoney.models.fields.CurrencyField(choices=[('EUR', 'EURO €')], default='EUR', editable=False, max_length=3)),
                ('given', djmoney.models.fields.MoneyField(blank=True, currency_choices=(('EUR', 'EURO €'),), decimal_places=2, default_currency='EUR', max_digits=9, null=True, verbose_name='Übergeben')),
                ('change_currency', djmoney.models.fields.CurrencyField(choices=[('EUR', 'EURO €')], default='EUR', editable=False, max_length=3)),
                ('change', djmoney.models.fields.MoneyField(blank=True, currency_choices=(('EUR', 'EURO €'),), decimal_places=2, default_currency='EUR', max_digits=9, null=True, verbose_name='Rückgeld')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_name', models.CharField(default='Allgemein', max_length=99, verbose_name='Gerichtskategorie')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('typ_name', models.CharField(default='Allgemein', max_length=99, verbose_name='Gerichtsvariate')),
                ('dish_category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='P5.DishCategory', verbose_name='Gerichtskategorie')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='dish',
            name='typ',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='P5.DishTyp'),
        ),
        migrations.CreateModel(
            name='BillDetail',
            fields=[
